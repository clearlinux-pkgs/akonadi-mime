...
Source0  : https://download.kde.org/stable/release-service/22.08.0/src/akonadi-mime-22.08.0.tar.xz
...
%prep
%setup -q -n akonadi-mime-22.08.0
cd %{_builddir}/akonadi-mime-22.08.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1661550070
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKF5AkonadiMime.so.5.21.0

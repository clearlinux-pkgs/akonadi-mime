...
Version  : 24.12.1
Release  : 82
URL      : https://download.kde.org/stable/release-service/24.12.1/src/akonadi-mime-24.12.1.tar.xz
Source0  : https://download.kde.org/stable/release-service/24.12.1/src/akonadi-mime-24.12.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.12.1/src/akonadi-mime-24.12.1.tar.xz.sig
...
%setup -q -n akonadi-mime-24.12.1
cd %{_builddir}/akonadi-mime-24.12.1
pushd ..
cp -a akonadi-mime-24.12.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1736544904
mkdir -p clr-build
pushd clr-build

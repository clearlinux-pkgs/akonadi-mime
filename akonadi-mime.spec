...
Source0  : https://download.kde.org/stable/release-service/22.08.2/src/akonadi-mime-22.08.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.08.2/src/akonadi-mime-22.08.2.tar.xz.sig
...
%prep
%setup -q -n akonadi-mime-22.08.2
cd %{_builddir}/akonadi-mime-22.08.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1665763300
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKF5AkonadiMime.so.5.21.2

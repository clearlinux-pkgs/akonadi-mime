...
Source0  : https://download.kde.org/stable/release-service/24.02.0/src/akonadi-mime-24.02.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.02.0/src/akonadi-mime-24.02.0.tar.xz.sig
...
%prep
%setup -q -n akonadi-mime-24.02.0
cd %{_builddir}/akonadi-mime-24.02.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1709272487
mkdir -p clr-build
pushd clr-build

...
Source0  : https://download.kde.org/stable/release-service/22.12.3/src/akonadi-mime-22.12.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.12.3/src/akonadi-mime-22.12.3.tar.xz.sig
...
%prep
%setup -q -n akonadi-mime-22.12.3
cd %{_builddir}/akonadi-mime-22.12.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1677793168
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKF5AkonadiMime.so.5.22.3

...
Version  : 23.08.3
Release  : 63
URL      : https://download.kde.org/stable/release-service/23.08.3/src/akonadi-mime-23.08.3.tar.xz
Source0  : https://download.kde.org/stable/release-service/23.08.3/src/akonadi-mime-23.08.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.08.3/src/akonadi-mime-23.08.3.tar.xz.sig
...
%prep
%setup -q -n akonadi-mime-23.08.3
cd %{_builddir}/akonadi-mime-23.08.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1701931162
mkdir -p clr-build
pushd clr-build

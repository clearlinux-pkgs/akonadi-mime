...
Source0  : https://download.kde.org/stable/release-service/22.04.1/src/akonadi-mime-22.04.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.04.1/src/akonadi-mime-22.04.1.tar.xz.sig
...
%prep
%setup -q -n akonadi-mime-22.04.1
cd %{_builddir}/akonadi-mime-22.04.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1652652461
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/akonadi-mime-22.04.1/CMakePresets.json.license %{buildroot}/usr/share/package-licenses/akonadi-mime/c085897bc39e05746ffd2d889a6e84ff1b7ae2d9
cp %{_builddir}/akonadi-mime-22.04.1/LICENSES/BSD-3-Clause.txt %{buildroot}/usr/share/package-licenses/akonadi-mime/9950d3fdce1cff1f71212fb5abd31453c6ee2f8c
cp %{_builddir}/akonadi-mime-22.04.1/LICENSES/CC0-1.0.txt %{buildroot}/usr/share/package-licenses/akonadi-mime/8287b608d3fa40ef401339fd907ca1260c964123
cp %{_builddir}/akonadi-mime-22.04.1/LICENSES/LGPL-2.0-only.txt %{buildroot}/usr/share/package-licenses/akonadi-mime/20079e8f79713dce80ab09774505773c926afa2a
cp %{_builddir}/akonadi-mime-22.04.1/LICENSES/LGPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/akonadi-mime/20079e8f79713dce80ab09774505773c926afa2a
cp %{_builddir}/akonadi-mime-22.04.1/LICENSES/LGPL-2.1-or-later.txt %{buildroot}/usr/share/package-licenses/akonadi-mime/6f1f675aa5f6a2bbaa573b8343044b166be28399
cp %{_builddir}/akonadi-mime-22.04.1/LICENSES/LGPL-3.0-only.txt %{buildroot}/usr/share/package-licenses/akonadi-mime/757b86330df80f81143d5916b3e92b4bcb1b1890
cp %{_builddir}/akonadi-mime-22.04.1/LICENSES/LicenseRef-KDE-Accepted-LGPL.txt %{buildroot}/usr/share/package-licenses/akonadi-mime/e458941548e0864907e654fa2e192844ae90fc32
cp %{_builddir}/akonadi-mime-22.04.1/LICENSES/LicenseRef-KDE-Accepted-LGPL.txt %{buildroot}/usr/share/package-licenses/akonadi-mime/e458941548e0864907e654fa2e192844ae90fc32
cp %{_builddir}/akonadi-mime-22.04.1/README.md.license %{buildroot}/usr/share/package-licenses/akonadi-mime/cadc9e08cb956c041f87922de84b9206d9bbffb2
cp %{_builddir}/akonadi-mime-22.04.1/metainfo.yaml.license %{buildroot}/usr/share/package-licenses/akonadi-mime/7ff5a7dd2c915b2b34329c892e06917c5f82f3a4
cp %{_builddir}/akonadi-mime-22.04.1/serializers/akonadi_serializer_mail.desktop.license %{buildroot}/usr/share/package-licenses/akonadi-mime/864bc0eb28c73bd997ac19ff91935ab771846615
pushd clr-build
%make_install
popd
...
/usr/lib64/libKF5AkonadiMime.so.5.20.1

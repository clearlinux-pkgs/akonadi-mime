...
Version  : 24.08.0
Release  : 77
URL      : https://download.kde.org/stable/release-service/24.08.0/src/akonadi-mime-24.08.0.tar.xz
Source0  : https://download.kde.org/stable/release-service/24.08.0/src/akonadi-mime-24.08.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.08.0/src/akonadi-mime-24.08.0.tar.xz.sig
...
%setup -q -n akonadi-mime-24.08.0
cd %{_builddir}/akonadi-mime-24.08.0
pushd ..
cp -a akonadi-mime-24.08.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1724643084
mkdir -p clr-build
pushd clr-build

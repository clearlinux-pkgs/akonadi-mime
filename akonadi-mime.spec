...
Source0  : https://download.kde.org/stable/release-service/24.12.2/src/akonadi-mime-24.12.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.12.2/src/akonadi-mime-24.12.2.tar.xz.sig
...
%setup -q -n akonadi-mime-24.12.2
cd %{_builddir}/akonadi-mime-24.12.2
pushd ..
cp -a akonadi-mime-24.12.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1738977680
mkdir -p clr-build
pushd clr-build
